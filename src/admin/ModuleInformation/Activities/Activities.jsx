    ...
    (async () => {
      try {
        ...
        const response = await fetch(
          `${SERVER_ENDPOINT}/participant-activity/`
        );
        if (response.ok) {
              ...
              <div className="mx-2 my-1 border rounded-lg overflow-x-scroll no-scrollbar lg:w-[75vw] md:w-[72vw] w-[91vw]">
                {ActivityArr?.length > 0 ? (
                  <table>
                    ...
                    <tbody>
                      {ActivityArr?.map((acitivity, index) => (
                        <tr key={index}>
                          ...
                          <td className="border-l border-b">
                            <ProgramCard programId={acitivity.programId} />
                          </td>
                          <td className="border-l border-b">
                          ...
                          <td className="border-l border-b">
                            <ParticipantCard
                              participantId={acitivity.participantId}
                          ...
                          <td className="border-l border-b">
                            <DateCard date={acitivity.created} />
                          </td>
                        </tr>
                      ))}
                    </tbody>
